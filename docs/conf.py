...
# -*- coding: utf-8 -*-
#
# clasp documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'clasp.tex', u'clasp Documentation',
...
man_pages = [
    (master_doc, 'clasp', u'clasp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'clasp', u'clasp Documentation',
     author, 'clasp', 'One line description of project.',
     'Miscellaneous'),
]
